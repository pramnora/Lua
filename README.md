...
Here are some simple programs...created just to wet one's appetite; and, so, get one 'started' off...going on the long road to fully 'mastering' learning the Lua progrmming language.  
